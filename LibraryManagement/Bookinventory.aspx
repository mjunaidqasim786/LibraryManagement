<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Bookinventory.aspx.cs" Inherits="LibraryManagement.Bookinventory" %>
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <img id="imgview" Height="150px" Width="100px" src="Book_Images/books.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ElibraryDBConnectionString %>" SelectCommand="SELECT * FROM [Book_Table]"></asp:SqlDataSource>
                     <div class="col">
                                 ...
                                 <ItemTemplate>
                                    <div class="container-fluid">
                                       <div class="row">
                                          ...
                                          <div class="col-lg-2">
                                             <asp:Image class="img-fluid" ID="Image1" runat="server" ImageUrl='<%# Eval("book_image") %>' />
                                          </div>
                                       </div>
                                    </div>
                                 </ItemTemplate>
