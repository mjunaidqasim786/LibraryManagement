    ...
    public partial class Bookinventory : System.Web.UI.Page
    {
        ...
        void updateBookByID()
        {
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    string filepath = "~/Book_Images/books";
                    ...
                    {
                        FileUpload1.SaveAs(Server.MapPath("Book_Images/" + filename));
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE Book_Table set book_name=@book_name, genre=@genre, author_name=@author_name, publisher_name=@publisher_name, publish_date=@publish_date, language=@language, edition=@edition, book_cost=@book_cost, number_of_pages=@number_of_pages, book_description=@book_description, actual_stock=@actual_stock, current_stock=@current_stock, book_image=@book_image where book_id='" + TextBox1.Text.Trim() + "'", con);
        ...
        void addNewBook()
        {
            try
            {
                ...
                string filepath = "~/Book_Images/books.png";
                string filename = Path.GetFileName(FileUpload1.PostedFile.FileName);
                FileUpload1.SaveAs(Server.MapPath("Book_Images/" + filename));
                filepath = "~/Book_Images/" + filename;
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_Table(book_id,book_name,genre,author_name,publisher_name,publish_date,language,edition,book_cost,number_of_pages,book_description,actual_stock,current_stock,book_image) values(@book_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@current_stock,@book_img_link);", con);
